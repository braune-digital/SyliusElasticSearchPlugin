...
namespace Sylius\ElasticSearchPlugin\Query\Compound;
...
class FunctionScoreQuery implements BuilderInterface
{
     ...
     * @return $this
     */
    public function addFieldValueFactorFunction($field, $factor, $modifier = 'none', $missing = 1, BuilderInterface $query = null)
    {
        $function = [
            'field_value_factor' => [
                'field' => $field,
